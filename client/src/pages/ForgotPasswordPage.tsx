...
export const ForgotPasswordPage = () => {
  ...
  // Extract backend message if mutation fails
    ...
    <div className="max-w-md mx-auto mt-20 animate-fade-in px-4">
      <div className="bg-white p-10 rounded-2xl shadow-xl border border-slate-100">
        ...
        {!sent ? (
          <>
            <p className="text-slate-500 text-sm mb-8">
              Enter your email and we'll generate a secure token to reset your credentials.
            </p>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              <Input 
                ...
                // 🟢 Displays validation errors first, fallbacks to backend API error
          ...
          <div className="text-center py-6">
            <div className="bg-green-50 text-green-700 p-4 rounded-xl mb-6 text-sm font-bold border border-green-100">
              Token generated! Check your backend server log for your link code.
            </div>
            <Link to="/login" className="text-aventon-dark font-black text-xs uppercase hover:underline">
              Back to Login
            </Link>
          </div>
        )}
