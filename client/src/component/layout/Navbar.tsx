  ...
  return (
    <nav className="bg-aventon-light text-aventon-dark shadow-lg sticky top-0 z-50">
      <div className="container mx-auto px-6 h-20 flex items-center justify-between">
        {/* Logo Section */}
        <Link to="/" className="text-2xl font-black tracking-tighter text-aventon-accent transition-colors">
        ...
        <div className="flex items-center gap-8 text-[11px] font-bold uppercase tracking-widest">
          ...
          {user ? (
            ...
            <div className="flex items-center gap-6">
              ...
              <Link 
                to="/register" 
                className="bg-aventon-accent text-aventon-light px-5 py-2.5 rounded-xl font-black hover:bg-aventon-light transition-all shadow-md"
              >
                Get Started
              </Link>
            </div>
